...
* This repository does not include an explicit license file. Add a license (e.g., MIT) to make reuse clear.
* Credits: GUI scaffold generated by MATLAB GUIDE. Processing functions: author of the project (check file headers for author info).

---

## Contact / author

If you want me to expand this README (add examples, screenshots, or usage scripts), or to convert the GUIDE GUI to an App Designer app, tell me what you'd like changed.
